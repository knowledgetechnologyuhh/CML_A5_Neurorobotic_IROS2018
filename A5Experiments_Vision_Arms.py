...
def runModel():
    ...
    from KEF.DataLoaders import VisionLoader_A5Experiments_ArmsFrameBased

    from KEF.Implementations import Vision_CNN_A5Experiment_Frame

    dataDirectory = "/data/experiments_A5_Vision_FrameBased_Arms/"

    datasetFolderTrain = "/data/datasets/A5_Experiments/A5VideoExperiments_separated/Arms_Average/train/"


    datasetFolderTest = "/data/datasets/A5_Experiments/A5VideoExperiments_separated/Arms_Average/test/"
    ...
    preProcessingProperties = [(80, 60), grayScale]
    ...
    dataLoader = VisionLoader_A5Experiments_ArmsFrameBased.VisionLoader_A5Experiments_Arms_FrameBased(experimentManager.logManager, preProcessingProperties)
    #
    ...
    cnnModel = Vision_CNN_A5Experiment_Frame.Vision_CNN_A5Experiment_Frame(experimentManager, "Vision_Deep_CNN", experimentManager.plotManager)
