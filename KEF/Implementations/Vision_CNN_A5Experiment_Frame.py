...
class Vision_CNN_A5Experiment_Frame(IModelImplementation.IModelImplementation):
    batchSize = 8
    numberOfEpochs = 150
    ...
    def buildModel(self, inputShape, numberOfOutputs):
        ...
        # Conv1 and 2
        conv1 = Conv2D(nch / 4, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv1")(inputLayer)
        #bn1 = BatchNormalization(axis=1)(conv1)
        actv1 = Activation("relu")(conv1)

        conv2 = Conv2D(nch / 4, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv2")(actv1)
        #bn2 = BatchNormalization(axis=1)(conv2)
        actv2 = Activation("relu")(conv2)

        # mp1 = MaxPooling2D(pool_size=(2, 2))(actv2)
        # drop1 = Dropout(0.25)(mp1)

        # # Conv 3 and 4
        # conv3 = Conv2D(nch / 2, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv3")(drop1)
        # bn3 = BatchNormalization(axis=1)(conv3)
        # actv3 = Activation("relu")(bn3)
        #
        # conv4 = Conv2D(nch / 2, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv4")(actv3)
        ...
        #
        # # Conv 5 and 6 and 7
        # conv5 = Conv2D(nch / 2, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv5")(drop2)
        # bn5 = BatchNormalization(axis=1)(conv5)
        # actv5 = Activation("relu")(bn5)
        #
        # conv6 = Conv2D(nch / 2, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv6")(actv5)
        # bn6 = BatchNormalization(axis=1)(conv6)
        # actv6 = Activation("relu")(bn6)
        #
        # conv7 = Conv2D(nch / 2, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv7")(actv6)
        ...
        # # Conv 8 and 9 and 10
        #
        # conv8 = Conv2D(nch, (3, 3), padding="same", kernel_initializer="glorot_uniform", name="conv8")(drop3)
        ...
        mp4 = MaxPooling2D(pool_size=(2, 2))(actv2)
        ...
        output = Dense(numberOfOutputs, activation="softmax")(dense)
    ...
    def train(self, dataPointsTrain, dataPointsValidation, dataAugmentation):
        ...
        #dataPointsValidation = dataPointsTrain
